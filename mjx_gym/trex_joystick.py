...
def joystick_config() -> config_dict.ConfigDict:
    ...
    config.reset_standing_prob = 1.0
    config.command_config.forward_min = 0.0
    config.command_config.forward_max = 1.0
    config.command_config.high_speed_min = 1.0
    config.command_config.high_speed_prob = 0.0
    config.command_config.turn_max = 0.35
    config.command_config.zero_prob = 0.10
    config.command_config.turn_zero_prob = 0.20
    config.apply_gait_prior_action = True
    config.gait_frequency_min = 0.9
    ...
    config.reward_config.scales.tracking_ang_vel = 1.5
